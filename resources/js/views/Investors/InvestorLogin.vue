        ...
        <div class="login-wrapper">
            <div class="auth-section">
                <div class="auth-card">
                    ...
                    <h4>Welcome Back!</h4>
                    <p class="auth-subtitle text-primary">Please login to your Investor Account</p>
                    <form @submit.prevent="loginCheck()">
                        ...
                        <router-link to="/investor/register" class="btn btn-primary btn-block btn-lg shadow-lg mt-2 auth-btn">
                            Register
                        </router-link>
