        ...
        <router-link to="/investors">
            <div class="card-body px-3 py-4-5">
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-center align-items-center">
                        <div class="stats-icon-big blue">
                            <i class="fa fa-solid fa-handshake"></i> <!-- Change icon for investors -->
                        </div>
                    </div>
                    <div class="col-md-12 mt-3 d-flex flex-column justify-content-center align-items-center">
                        <h3 class="font-extrabold mb-0">{{ record.investor_count }}</h3> <!-- Investors count -->
                        <h5 class="text-muted font-semibold">{{ __('investors') }}</h5> <!-- Investors label -->
                    </div>
                </div>
            </div>
        </router-link>
