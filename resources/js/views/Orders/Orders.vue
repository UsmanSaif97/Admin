                                ...
                                <div class="table-responsive mt-3">
                                    <b-table
                                        ...
                                        <template #cell(active_status)="row">
                                            ...
                                            <span v-else-if="row.item.active_status == '7'" class="badge bg-danger">Cancelled</span>
                                            <span v-else-if="row.item.active_status == '8'" class="badge bg-danger">Returned</span>
        ...
        getOrders(){
            ...
            axios.get(this.$apiUrl + '/orders',{ 
                params: param
                    ...
                    this.totalOrderItemRows = response.data.data.order_items_total;
