                ...
                <!-- <form method="post" enctype="multipart/form-data" @submit.prevent="saveRecord"> -->
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class=" row -align-items-center"  >
                                <div class="form-group col-md-4">
                                     <label for="phone_login">{{ __('phone_login') }}<span class="text text-primary font-size-13">( {{ __('enable') }}/{{ __('disable') }} )</span></label><br>
                                    <div class="form-check form-switch">
                                ...
                                <div class="form-group col-md-4">
                                     <label for="google_login">{{ __('google_login') }}<span class="text text-primary font-size-13">( {{ __('enable') }}/{{ __('disable') }} )</span></label><br>
                                    <div class="form-check form-switch">
                                ...
                                <div class="form-group col-md-4">
                                     <label for="apple_login">{{ __('apple_login') }}<span class="text text-primary font-size-13">( {{ __('enable') }}/{{ __('disable') }} )</span></label><br>
                                    <div class="form-check form-switch">
