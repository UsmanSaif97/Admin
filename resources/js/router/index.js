...
const Investors = () => import("../views/Investor/Investors");
const EditInvestor = () => import("../views/Investor/EditInvestor");
const InvestorCommissions = () => import("../views/Investor/Commissions/InvestorCommissions");
const InvestorWalletTransactions = () => import("../views/Investor/WalletTransactions/InvestorWalletTransactions");
...
/*Investor*/ 
const InvestorRegister = () => import("../views/Investors/InvestorRegister");
const InvestorDetails = () => import("../views/Investors/InvestorDetails");
const InvestorLogin = () => import("../views/Investors/InvestorLogin");
const InvestorDashboard = () => import("../views/Investors/Dashboard");
const InvestorOrders = () => import("../views/Investors/Orders");
// const InvestorWithdrawalRequests = () => import("../views/Investors/WithdrawalRequests/WithdrawalRequests");
// const InvestorProductSalesReports = () => import("../views/Investors/ProductSalesReports");
// const InvestorSalesReports = () => import("../views/Investors/SalesReports");
// const InvestorSettings = () => import('../views/Settings');
// const InvestorProfile = () => import("../views/Investors/EditInvestor");
// const InvestorViewProduct = () => import("../views/Product/ViewProduct");
...
router.beforeEach((to, from, next) => {
    ...
    if(isInstalled) {
        ...
        var nonloginRoute = ['install', 'login', 'seller_register', 'delivery_boy_register', 'forgot_password', 'reset_password', 'seller_login', 'delivery_boy_login', 'investor_login', 'investor_register'];
        if (!nonloginRoute.includes(to.name)) {
            if (Auth.check()) {
                ...
                if (Auth.user.role_id === 3 && Auth.user.seller_status === 0) {
                    ...
                    return;
                } else if (Auth.user.role_id === 5 && Auth.user.investor_status === 0) {
                    //Investor
                    if (to.name == "investor_details") {
                        next();
                        return;
                    }
...
function configRoutes() {
  ...
  var sellerRoles = [roleSeller];
     ...
     var investorRoles = [roleInvestor];
...
fetchData();
    fetchData().then(result => {
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    path: "investors",
                    name: "Investors",
                    component: Investors, // Make sure you have the Investors component imported
                    meta: {
                        permission: 'investor_list', // Adjust as necessary based on your permissions
                        role: adminRoles,
                        title: 'Investors'
                    },
                },
                {
                    ...
                    name: "CreateInvestor",
                    component: EditInvestor, // Ensure you have the EditInvestor component imported
                    meta: {
                ...
                {
                    path: "investor_commissions",
                    name: "Investor Commissions",
                    component: InvestorCommissions, // Make sure this component is imported
                    meta: {
                        permission: 'investor_commission_list', // Adjust as necessary
                        role: adminRoles,
                        title: 'Investor Commissions'
                    },
                },
                {
                    path: "investor_wallet_transactions",
                    name: "Investor Wallet Transactions",
                    component: InvestorWalletTransactions, // Ensure this component is imported
                    meta: {
                        permission: 'investor_wallet_transaction_list', // Adjust as necessary
                        role: adminRoles,
                        title: 'Investor Wallet Transactions'
                    },
                },
        ...
        //Inverstor Details route start here
        {
            path: "/investor/login", //working
            name: "investor_login",
        ...
        {
            path: "/investor/register", //working but black page with 
            name: "investor_register",
        ...
        {
            path: "/investor/details", //redirect to / page problem
            ...
            children: [
                ...
                },
                {
                    ...
                    meta: {
                        ...
                        requiresAuth: true,
                        role: investorRoles,
                        title: 'Investor Orders'
                    }
                },
                // {
                //     path: "product-info",
                //     name: "InvestorProductInfo",
                //     component: InvestorProductInfo,
                //     meta: {
                //         requiresAuth: true,
                //         role: investorRoles,
                //         title: 'Product Info'
                ...
                //     name: "InvestorReturnRequests",
                //     component: InvestorReturnRequests,
                //     meta: {
                //         requiresAuth: true,
                //         role: investorRoles,
                //         title: 'Return Requests'
                ...
                //     name: "InvestorWithdrawalRequests",
                //     component: InvestorWithdrawalRequests,
                //     meta: {
                //         requiresAuth: true,
                //         role: investorRoles,
                //         title: 'Withdrawal Requests'
