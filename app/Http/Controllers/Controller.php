...
class Controller extends BaseController
{
    ...
    public function getInvestors()
    {
        ...
        $investors = Investor::all(); // Adjust based on your Investor model
        
        return CommonHelper::responseWithData($investors);
    }
    ...
    public function createInvestor(Request $request)
    {
        ...
        return CommonHelper::responseWithData($investor, 'Investor created successfully!');
    }
    ...
    public function updateInvestor(Request $request, $id)
    {
        ...
        return CommonHelper::responseWithData($investor, 'Investor updated successfully!');
    }
    ...
    public function deleteInvestor($id)
    {
        ...
        return CommonHelper::responseWithData(null, 'Investor deleted successfully!');
    }
