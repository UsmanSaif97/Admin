...
class PermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        $permissionsToSeed = [ 
            ...
            /* Investors */
[
    'name' => ['investor_list', 'investor_create', 'investor_update', 'investor_delete'],
    ...
    'default_roles' => ['Super Admin', 'Admin']
            ...
            [
                'name' => [
                    ...
                    'manage_privacy_policy_seller_app','manage_privacy_policy_investor_app','manage_secret_key','manage_shipping_methods','manage_system_registration'],
...
/**********************************************************************************************/
        ...
        $permissionsToSeed = [
            ...
            /*investor*/
            [
                'name' => ['manage_investors', 'investor_create', 'investor_list'],
                'category_name' => 'investor',
                'default_roles' => ['Investor'] // Adjust this as needed
            ],
