  ...
  data: function data() {
    return {
      ...
      sidebarItems: [{
        ...
        submenu: [
            {
                name: __('add_investor'),
                icon: 'grid-fill', 
                url: '/investors/create',
                permission: 'seller_create'
            },
            {
                name: __('investor_requests'),
                icon: 'grid-fill', // or 'edit', choose one
                url: '/registered_investors',
                permission: 'seller_list'
            },
            {
                name: __('manage_investors'),
                icon: 'grid-fill', // or 'edit', choose one
                url: '/investors',
                permission: 'seller_list'
            },
            {
                name: __('investor_wallet_transactions'),
                icon: 'grid-fill',
                url: '/investor_wallet_transactions',
                permission: 'investor_list'
            },
            {
                name: __('policies_investor'),
                icon: 'grid-fill',
                url: '/privacy_policy_investor',
          permission: 'manage_privacy_policy_seller_app'
            }
        ]
    },
    ...
    logout: function logout() {
      ...
      setTimeout(function () {
        if (role_id === 3) {
          ...
          _this2.$router.push('/investr/login');
        } else {
