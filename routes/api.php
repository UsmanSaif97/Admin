...
Route::group(['middleware' => ['auth:api']], function () {  
    ...
    Route::group(['prefix' => 'investors'], function () {
        ...
        Route::get('{id}', [\App\Http\Controllers\InvestorController::class, 'show'])->name('investors.show');
        Route::post('save', [\App\Http\Controllers\InvestorController::class, 'store'])->name('investors.store');
        Route::put('update/{id}', [\App\Http\Controllers\InvestorController::class, 'update'])->name('investors.update');
        Route::delete('delete/{id}', [\App\Http\Controllers\InvestorController::class, 'destroy'])->name('investors.destroy');
    });
    
    Route::group(['prefix' => 'investments'], function () {
        Route::get('/', [\App\Http\Controllers\InvestmentController::class, 'index'])->name('investments.index');
        Route::get('{id}', [\App\Http\Controllers\InvestmentController::class, 'show'])->name('investments.show');
        Route::post('save', [\App\Http\Controllers\InvestmentController::class, 'store'])->name('investments.store');
        Route::put('update/{id}', [\App\Http\Controllers\InvestmentController::class, 'update'])->name('investments.update');
        Route::delete('delete/{id}', [\App\Http\Controllers\InvestmentController::class, 'destroy'])->name('investments.destroy');
    });
