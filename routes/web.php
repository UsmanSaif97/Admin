...
Route::get('investors/{investor_id}/total-investments', [InvestmentController::class, 'totalInvestments']);


Route::get('/investors/{investor_id}/installments', [InstallmentController::class, 'index'])->name('investors.installments');
Route::get('/investors/{investor_id}/installments/create', [InstallmentController::class, 'create'])->name('installments.create');
Route::post('/investors/{investor_id}/installments', [InstallmentController::class, 'store'])->name('installments.store');
